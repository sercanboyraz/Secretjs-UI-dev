...
class Exception extends React.Component<any, any> {
  public render() {
    ...
    return (
      <Row style={{ marginTop: 150,color:'#fff !important' }}>
        <Col
          xs={{ span: 7, offset: 1 }}
          sm={{ span: 7, offset: 1 }}
          md={{ span: 7, offset: 1 }}
        ...
        >
          <Avatar shape="square" className={'errorAvatar'} style={{color:'#fff !important'}} src={error!.errorImg} />
        </Col>
        <Col
          xs={{ span: 7, offset: 1 }}
          sm={{ span: 7, offset: 1 }}
        ...
        >
          ...
          >
            <h1 className={'errorTitle'} style={{color:'#fff !important'}}>{error!.errorCode}</h1>
          </Col>
          <Col
            xs={{ span: 24, offset: 0 }}
            sm={{ span: 24, offset: 0 }}
            ...
            xxl={{ span: 24, offset: 0 }}
          >
            <h5 className={'errorDescription'} style={{color:'#fff !important'}}> {error!.errorDescription}</h5>
          </Col>
          <Col
            xs={{ span: 24, offset: 0 }}
            sm={{ span: 24, offset: 0 }}
